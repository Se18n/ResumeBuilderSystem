...
import { RESUME_TEMPLATES, EMPTY_RESUME } from '../utils/constants';
...
const CreateResume: React.FC = () => {
  ...
  useEffect(() => {
    // Set document title
    document.title = 'Create Resume | ResumeBuilder';
  }, []);
  ...
  const handleSave = () => {
    try {
      ...
      setAlertMessage({ type: 'success', message: 'Resume created successfully!' });
      ...
      setAlertMessage({ type: 'error', message: 'Failed to create resume. Please try again.' });
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Fill in your details to create a professional resume</p>
          </div>
        </div>
